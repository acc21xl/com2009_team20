...
class colour_search(object):
    ...
    def camera_callback(self, img_data):
        ...
        lower_blue = (50, 50, 100)
        upper_blue = (180, 255, 255)
        #lower_lightBlue = (75, 50, 100)
        #upper_lightBlue = (100, 255, 255)
        lower_red = (0, 50, 100)
        upper_red = (15, 255, 255)
        #lower_green = (50, 70, 100)
        #upper_green = (7   0, 255, 255)
        mask = cv2.inRange(hsv_img, np.bitwise_or(lower_blue,lower_red), np.bitwise_or(upper_blue,upper_red))
